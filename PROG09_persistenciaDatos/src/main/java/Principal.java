...
public class Principal {
    ...
    static Banco banco; //xa o crea ao usar o método leer()
    static int opcion;
    ...
    public static void main(String[] args) {
        banco = data.leer();//para que ao iniciar cargue o contido do ficheiro datoscuentasbancarias.dat.
        if (banco == null) //que nos cree o banco se non existe
        {
            banco = new Banco();
        }
        do {
            ...
            switch (opcion) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    data.guardar(banco);//para que ao saír volque o contido da estructura de datos coas contas bancarias a datoscuentasbancarias.dat.
                    break;
            }
        } while (opcion != 8);
