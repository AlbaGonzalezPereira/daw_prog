...
public class Principal {
    ...
    private static void eliminarV() {
        Scanner sc = new Scanner(System.in);
        System.out.println("Introduce a matrícula a buscar: ");
        String matricula = sc.nextLine();
        if (concesionario.eliminarVehiculo(matricula)) {
            System.out.println("O vehículo cuia matrícula é " + matricula + " eliminouse correctamente");
        } else {
            System.out.println("O vehículo cuia matrícula é " + matricula + " non pudo eliminarse");
        }
    }
